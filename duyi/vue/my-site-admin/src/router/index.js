    ...
    children: [
      {
        ...
        meta: { title: '首页轮播', icon: 'el-icon-picture', auth: true }
      }
    ]
  },

  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '文章分类', icon: 'el-icon-tickets', auth: true }
      },
      {
        path: 'add',
        name: 'BlogAdd',
    ...
    children: [
      {
        ...
        meta: { title: '项目列表', icon: 'el-icon-suitcase', auth: true }
      },
      {
        path: 'add',
        name: ' ProjectAdd',
        component: () => import('@/views/project/add'),
        meta: { title: '添加项目', icon: 'el-icon-first-aid-kit', auth: true }
      }
    ]
  },
    ...
    children: [
      {
        ...
        meta: { title: '留言板', icon: 'el-icon-s-claim', auth: true }
      }
    ]
  },
